...
@section('title', 'History Peminjaman Inventory')
                ...
                <div class="col-sm-12">
                    <div class="card shadow-sm">
                        <div class="card-header bg-danger text-light font-weight-bold">
                            <span>History Peminjaman Inventory</span>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($row->status_peminjaman == 'Disetujui')
                                                    <span class="btn btn-sm btn-success font-weight-bold">{{$row->status_peminjaman}}</span>
                                                @elseif($row->status_peminjaman == 'Tidak Disetujui')
                                                    <span class="btn btn-sm btn-danger font-weight-bold">{{$row->status_peminjaman}}</span>
                                                @else
                                                    <span class="btn btn-sm btn-info font-weight-bold">{{$row->status_peminjaman}}</span>
                                                @endif
                                            </td>
                                            <td>{{$row->penyetuju}}</td>
                                        </tr>
