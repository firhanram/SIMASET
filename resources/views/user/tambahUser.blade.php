               ...
               <div class="col-sm-6 m-auto"><!-- col of form add user -->
                    <div class="card shadow-sm"><!-- card -->
                        ...
                        <div class="card-body"><!-- body of card -->
                            ...
                            @endif
                            <form action="{{url('/user/tambahUser/add')}}" method="post">
                                {{csrf_field()}}
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        <label for="fullName">Full Name</label>
                                        <input type="text" class="form-control form-control-rounded" name="fullName" id="fullName">
                                    </div>
                                    <div class="form-group col-sm-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="email" class="form-control form-control-rounded" name="email" id="email">
                                    </div>
                                </div>
