               ...
               <div class="col-sm-8 m-auto"><!-- col of form add user -->
                    <div class="card shadow-sm"><!-- card -->
                        ...
                        <div class="card-body"><!-- body of card -->
                            ...
                            @endif
                            <form action="{{url('/transaksi/barang/tambah_barang/add')}}" method="post">
                                {{csrf_field()}}
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        <label for="kdBarang">Kode Barang</label>
                                        <input type="text" class="form-control form-control-rounded" name="kdBarang" id="kdBarang" value="{{$kd_barang}}" readonly>
                                    </div>
                                    <div class="form-group col-sm-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select name="jenis" id="jenis" class="form-control form-control-rounded custom-select @error('jenis') is-invalid @enderror">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select name="kategori" id="kategori" class="form-control form-control-rounded custom-select @error('kategori') is-invalid @enderror">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-rounded @error('nomorSeri') is-invalid @enderror" name="nomorSeri" id="nomorSeri">
                                        @error('nomorSeri')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-rounded" name="satuan" id="satuan">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="spesifikasi">Spesifikasi</label>
                                    <textarea name="spesifikasi" id="spesifikasi" class="form-control form-control-rounded" ></textarea>
                                </div>
