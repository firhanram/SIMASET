                ...
                <div class="col-sm-8 m-auto">
                    <div class="card shadow-sm">
                        <div class="card-header bg-danger text-light font-weight-bold">
                            <span>Detail Barang Inventory</span>
                        </div>
                        <div class="card-body">
                            @foreach($data as $row)
                            <div class="form-group row">
                                <label for="noInventory" class="form-label col-sm-4"><strong>Nomor Inventory</strong></label>
                                <div class="col-sm-8">
                                    <input type="text" readonly class="form-control-plaintext" id="kdBarang" value="{{$row->no_inventory}}">
                                </div>
                            </div>
                            <div class="form-group row">
