...
@section('title', 'Pemberhentian Aset')
...
<div id="content-wrapper" class="d-flex flex-column"><!-- content wrapper-->
    <div class="content"><!-- main content -->
        ...
        <div class="container-fluid"><!-- Begin Container Fluid -->
            <div class="row">
                <div class="col-xl-3">
                    <a class="btn btn-danger" href="{{ url('aset/pemberhentian/input_pemberhentian_aset')}}" role="button">
            ...
            <div class="row mt-2">
              @livewire('aset.pemberhentian-aset-index')
            </div>
