...
@section('title', 'Pemakaian Inventory')
                ...
                <div class="col-sm-6 m-auto">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{url('/manager/pemakaian_inventory/add')}}" method="POST">
                                {{csrf_field()}}
                                @foreach($data as $row)
                                <div class="form-group row">
                                    <label for="tanggalPemakaian" class="col-form-label col-sm-4">Tanggal Pemakaian*</label>
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control form-control-rounded @error('tanggalPemakaian') is-invalid @enderror" name="tanggalPemakaian" id="tanggalPemakaian">
                                        @error('tanggalPemakaian')
