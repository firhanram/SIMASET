                ...
                <div class="col-sm-6 m-auto">
                    <div class="card shadow-sm">
                        <div class="card-header bg-danger text-light font-weight-bold">
                            <span>Input Pengajuan Peminjaman Aset</span>
                        </div>
                        <div class="card-body">
                            @if(session('error'))
                            ...
                            @endif
                            <form action="{{url('/manager/peminjaman_aset/add')}}" method="POST">
                                {{csrf_field()}}
                                @foreach($data as $row)
                                ...
                                <div class="form-group row">
                                    <label for="noAset" class="col-sm-label col-sm-4">Nomor Aset</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-rounded" name="noAset" id="noAset"  value="{{$row->no_aset}}"readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
